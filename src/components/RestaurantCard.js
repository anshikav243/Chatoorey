...
const RestaurantCard = (props) => {
    ...
    return (
        <div className="m-4 w-[220px] p-2 justify-evenly items-center">
          <div>
  ...
  return (props) => {
    ...
    return (
      <div className="relative w-[220px]">   
        <div className="absolute translate-y-[194px] h-[50px] w-[204px] bg-gradient-to-t from-gray-950 m-6"></div>  
